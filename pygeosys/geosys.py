...
class geosys():
    def __init__(self,  
        ...
        self.vts_endpoint = "https://api-pp.geosys-na.net/vegetation-time-series/v1/season-fields/values?$offset=0&$limit=2000&$count=false&SeasonField.Id=lqlvxgb&index=NDVI"
        self.str_id_server_url = "https://identity.preprod.geosys-na.com/v2.1/connect/token"
    ...
    def __authenticate(self):
        try :
            oauth = OAuth2Session(client=LegacyApplicationClient(client_id=self.str_api_client_id)) 
    ...
    def __create_season_field_id(self, polygon):
        ...
        str_url_endpoint = urljoin(self.base_endpoint, self.master_data_management_endpoint)
